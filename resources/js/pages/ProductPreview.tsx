        ...
        <>
            ...
            <main>
                <div className="grid grid-cols-2 justify-items-center text-xl">
                    ...
                    <div>
                        ...
                        <div className="mt-36 grid grid-cols-8 grid-rows-2 place-items-center gap-4 [&>*]:h-full [&>*]:w-full [&>*]:border-2 [&>*]:p-4">
                            ...
                            >
                                {bookmarked ? (
                                    <FaBookmark className="col-span-1 row-start-2" />
                                ) : (
                ...
                <p className="mt-96 text-9xl">
                    ...
                    dictum urna quam nec urna. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.
                    ...
                    faucibus eget in metus. In pellentesque faucibus vestibulum. Nulla at nulla justo, eget luctus tortor. Nulla facilisi. Duis
                    aliquet egestas purus in blandit. Curabitur vulputate, ligula lacinia scelerisque tempor, lacus lacus ornare ante, ac egestas est
                    urna sit amet arcu. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Sed molestie augue
                    sit amet leo consequat posuere. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Proin vel
                    ante a orci tempus eleifend ut et magna. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                </p>
                <div
